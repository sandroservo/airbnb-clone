     ...
     grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      >
        <input value={searchInput}
         ...
         bg-tansparent outline-none text-sm
         text-gray-600 placeholder-gray-400'
          type="text"
          placeholder={placeholder || "Sart your search"} />
      ...
      {searchInput && (
        <div className='flex flex-col col-span-3 mx-auto'>
          ...
          <div className="flex items-center border-b mb-4">
            <h2 className='text-2xl pl-2 flex-grow font-semibold'>Number of Guests
            </h2>
            ...
            <input
              ...
              type="number"
              min={1}
              className=" w-12 pl-2 text-lg out-line-none text-red-400"
            />
          </div>
          ...
          <div className="flex">
            ...
            <button
              onClick={search}
              className="font-semibold flex-grow text-red-500">Search</button>
          </div>
        </div>
      )}
    </header>
